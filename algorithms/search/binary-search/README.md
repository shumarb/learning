...
2. Download these Java source files in the [Code](https://github.com/shumarb/code/tree/main) repository: [BinarySearch.java](https://github.com/shumarb/code/blob/main/algorithms/search/BinarySearch.java), and [BasicOperations.java](https://github.com/shumarb/code/blob/main/BasicOperations.java).
